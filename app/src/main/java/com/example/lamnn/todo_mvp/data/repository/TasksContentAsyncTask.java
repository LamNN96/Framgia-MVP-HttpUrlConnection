...
public class TasksContentAsyncTask extends AsyncTask<String, Void, List<Task>> {
    private TasksDataSource.GetDataCallback mCallback;
    private Exception mException;

    public TasksContentAsyncTask(TasksDataSource.GetDataCallback  callback) {
        mCallback = callback;
    }
